...
function defaults {
    ...
    : ${CKAN_SITE_URL:="https://127.0.0.1:8443"}
    : ${GOOGLE_UA:="UA-UNSET"}
    ...
    export AWS_HOST_NAME_TO_S3 REGION_NAME SIGNATURE_VERSION
...
function make_config {
    cat /etc/ckan/default/ckan.ini.in | \
        sed -e "s#@AWS_ACCESS_KEY_ID@#$AWS_ACCESS_KEY_ID#" \
            ...
            -e "s#@REGION_NAME@#$REGION_NAME#" \
            -e "s#@SIGNATURE_VERSION@#$SIGNATURE_VERSION#" \
