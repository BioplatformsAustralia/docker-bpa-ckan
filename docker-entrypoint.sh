...
function defaults {
    ...
    export CKANEXT_OIDC_PKCE_BPA_TSI_ROLE
    export CKANEXT_OIDC_PKCE_BPA_TSI_ORG_ID
}
...
function make_config {
	...
	-e "s#@AWS_ACCESS_KEY_ID@#$AWS_ACCESS_KEY_ID#" \
        ...
        -e "s#@CKANEXT_OIDC_PKCE_BPA_TSI_ROLE@#$CKANEXT_OIDC_PKCE_BPA_TSI_ROLE#" \
        -e "s#@CKANEXT_OIDC_PKCE_BPA_TSI_ORG_ID@#$CKANEXT_OIDC_PKCE_BPA_TSI_ORG_ID#" /etc/ckan/default/ckan.ini \
    sed -i \
