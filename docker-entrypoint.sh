...
function defaults {
    ...
    export CKANEXT_OIDC_PKCE_BPA_APP_METADATA_CLAIM
...
function make_config {
	...
	-e "s#@AWS_ACCESS_KEY_ID@#$AWS_ACCESS_KEY_ID#" \
        ...
        -e "s#@CKANEXT_OIDC_PKCE_BPA_APP_METADATA_CLAIM@#$CKANEXT_OIDC_PKCE_BPA_APP_METADATA_CLAIM#" \
        -e "s#@CKANEXT_OIDC_PKCE_BPA_REGISTER_REDIRECT_URL@#$CKANEXT_OIDC_PKCE_BPA_REGISTER_REDIRECT_URL#" /etc/ckan/default/ckan.ini \
    sed -i \
