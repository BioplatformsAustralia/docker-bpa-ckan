...
function defaults {
    ...
    : ${CKAN_SQLALCHEMY_URL="postgresql://${DBUSER}:${DBPASS}@${DBSERVER}/${DBNAME}"}
    : ${CKAN_DATASTORE_WRITE_URL="postgresql://${DATASTORE_DBUSER}:${DATASTORE_DBPASS}@${DATASTORE_DBSERVER}/${DATASTORE_DBNAME}"}
    : ${CKAN_DATASTORE_READ_URL="postgresql://${DATASTORE_DB_READONLY_USER}:${DATASTORE_DB_READONLY_PASS}@${DATASTORE_DBSERVER}/${DATASTORE_DBNAME}"}
